...
public class UserDashBoardFormController {
    ...
    public AnchorPane UserDashBoardForm;


    public void goToDashBord(ActionEvent actionEvent) throws IOException {
        Stage stage = (Stage) UserDashBoardForm.getScene().getWindow();
        stage.close();
    ...
    public void goToStudentForm(MouseEvent mouseEvent) throws IOException {
        ...
        Parent load = FXMLLoader.load(resource);
        UserDashBoardForm.getChildren().clear();
        UserDashBoardForm.getChildren().add(load);
